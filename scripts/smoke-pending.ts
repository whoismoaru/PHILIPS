...
// Bentuknya boleh satu baris atau blok (awaitingSecret ikut sejak 30 Agu 2026) —
// yang dijaga adalah clearEdit benar-benar terpanggil dari registerFlowReset.
assert.ok(/registerFlowReset\([\s\S]{0,200}?clearEdit\(uid\)/.test(w), 'perintah lain tak membatalkan prompt');
